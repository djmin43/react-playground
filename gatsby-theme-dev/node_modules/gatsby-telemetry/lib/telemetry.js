...
const typedUUIDv4 = _gatsbyCoreUtils.uuid.v4;
...
class AnalyticsTracker {
  ...
  captureEvent(type = ``, tags = {}, opts = {
    ...
    this.buildAndStoreEvent(eventType, (0, _merge2.default)({}, tags, decoration));
  }
  ...
  captureError(type, tags = {}) {
    ...
    this.formatErrorAndStoreEvent(eventType, (0, _merge2.default)({}, tags, decoration));
  }
  ...
  buildAndStoreEvent(eventType, tags) {
    const event = {
      ...
      ...(0, _merge2.default)({}, this.defaultTags, tags),
