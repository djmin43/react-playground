...
function multipleRootQueriesError(filePath, def, otherDef) {
  ...
  const unifiedName = `${(0, _camelCase2.default)(name)}And${(0, _upperFirst2.default)((0, _camelCase2.default)(otherName))}`; // colors are problematic for tests as we can different
