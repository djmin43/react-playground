...
exports.deleteRenderer = exports.buildRenderer = void 0;
    ...
    return {
      recompileAndResumeWatching: async function recompileAndResumeWatching(allowTimedFallback) {
        ...
        return await new Promise(resolve => {
          ...
          _redux.emitter.on(`DEV_SSR_COMPILATION_DONE`, finish); // we reset it before we start compilation to be able to catch any invalid events
...
const doBuildPages = async (rendererPath, pagePaths, activity, workerPool, stage) => {
  try {
    ...
    const prettyError = (0, _errors.createErrorFromString)(error.stack, `${rendererPath}.map`);
