...
module.exports = async program => {
  ...
  const app = (0, _express.default)(); // Proxy gatsby-script using off-main-thread strategy

  const {
    partytownProxiedURLs = []
  } = config || {};
  app.use(_proxy.thirdPartyProxyPath, (0, _proxy.partytownProxy)(partytownProxiedURLs)); // eslint-disable-next-line new-cap
  ...
  if ("4" === `4`) {
    ...
    } catch (error) {// TODO: Handle case of engine not being generated
    }
  }
