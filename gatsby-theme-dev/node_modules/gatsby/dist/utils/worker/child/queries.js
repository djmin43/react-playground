...
async function saveQueriesDependencies() {
  ...
  (0, _redux.savePartialStateToDisk)([`queries`, `telemetry`], process.env.GATSBY_WORKER_ID, pickNecessaryQueryState); // make sure page query results we put in lmdb-store are flushed
