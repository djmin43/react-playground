...
const removeExportQueryParam = path => path === null || path === void 0 ? void 0 : path.split(`?`)[0];
/**
...
function doesModuleMatchResourcePath(resourcePath, webpackModule) {
  ...
  return webpackModule.modules.some(innerModule => removeExportQueryParam(innerModule.resource) === resourcePath);
}
/**
...
class StaticQueryMapper {
  ...
  apply(compiler) {
    ...
    compiler.hooks.done.tap(this.name, stats => {
      ...
      for (const [staticQueryId, webpackModules] of webpackModulesByStaticQueryId) {
      ...
      for (const [componentPath, webpackModules] of webpackModulesByComponentId) {
        for (const webpackModule of webpackModules) {
          for (const chunk of compilation.chunkGraph.getModuleChunksIterable(webpackModule)) {
            for (const chunkGroup of chunk.groupsIterable) {
      ...
      components.forEach(component => {
        ...
        if (!(0, _isEqual2.default)(this.store.getState().staticQueriesByTemplate.get(component.componentPath), staticQueryHashes)) {
          this.store.dispatch({
