...
const ensurePathComponentInSSRBundle = async (page, directory, allowTimedFallback) => {
  ...
  const htmlComponentRendererPath = _path.default.join(directory, _constants.ROUTES_DIRECTORY, `render-page.js`); // This search takes 1-10ms
...
new Promise(async (resolve, reject) => {
  ...
  try {
    await (0, _getPageData.getPageData)(pageObj.path, // 15000 is default timeout for this function - we keep it here for scenarios
