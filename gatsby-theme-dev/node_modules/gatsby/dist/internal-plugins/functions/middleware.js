...
async function executeFunction(req, res, next) {
  if (req.context) {
    ...
    const context = req.context; // we don't want to leak internal context to actual request handler
    ...
    try {
      ...
      _reporter.default.error(e); // Don't send the error if that would cause another error.
