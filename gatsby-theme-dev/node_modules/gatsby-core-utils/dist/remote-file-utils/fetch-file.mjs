...
export async function requestRemoteNode(url, headers, tmpFilename, httpOptions, attempt = 1) {
  ...
  return new Promise((resolve, reject) => {
    ...
    responseStream.on(`error`, async error => {
      ...
      statusCode && STATUS_CODES_TO_RETRY.includes(statusCode) || // GENERAL NETWORK ERRORS
