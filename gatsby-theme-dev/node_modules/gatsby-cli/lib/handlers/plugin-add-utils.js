...
const addPluginToConfig = (src, srcPath, {
  ...
  try {
    ...
    code = (_transform = (0, _core.transform)(src, transformOptions)) === null || _transform === void 0 ? void 0 : _transform.code; // Add back stripped type import, do light formatting, remove added empty module export.
...
const executeInstalls = async root => {
  // @ts-ignore - fix me
  const types = (0, _groupBy2.default)(installs, c => c.resource.dependencyType); // Grab the key of the first install & delete off installs these packages
  // then run intall
