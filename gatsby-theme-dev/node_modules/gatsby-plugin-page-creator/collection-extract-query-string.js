...
function collectionExtractQueryString(absolutePath, reporter) {
  ...
  const modelType = (0, _pathUtils.extractModel)(absolutePath); // This can happen if you have an invalid path and you are trying to query for that path
  ...
  const fileContents = _fsExtra.default.readFileSync(absolutePath).toString(); // 2.  If the user is using the collectionGraphql function, we have to
